...
angular.module('myApp.viewRegistrarReposterias', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/viewRegistrarReposterias', {
    templateUrl: 'viewRegistrarReposterias/viewRegistrarReposterias.html',
    controller: 'ViewRegistrarReposteriasCtrl'
  });
}])

.controller('ViewRegistrarReposteriasCtrl', ['$scope','postres','postresChange',function($scope,postres,postresChange) {
